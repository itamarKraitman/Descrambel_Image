...
def rotate_tile_to_original(tile_rotated: np.ndarray, rotation_direction: str) -> np.ndarray:
    """
...
def find_tile_and_place_in_descrambled(tile : tuple):
    ...
    tile_descrambled = rotate_tile_to_original(tile_rotated=tile_in_scrambled, rotation_direction=rotation)
